...
class PositionComboGame:
    ...
    def resolve_round(self):
        ...
        for player_id, submission in self.match_submissions.items():
            ...
            player_data[player_id] = {
                "player": player_id, "cells": sorted(list(submission)), "values": ordered_cell_values,
                "hand": hand_name, "rank_tuple": hand_rank_tuple, "points_gained_this_round": 0
            }
        ...
        for p_id in ['player1', 'player2']:
            ...
            player_data[p_id]['rank'] = player_data[p_id]['rank_tuple'][0]
            del player_data[p_id]['rank_tuple']
        round_results = [player_data['player1'], player_data['player2']]
        self.match_round += 1
        self.match_submissions = {'player1': None, 'player2': None}
        if self.match_round >= self.total_rounds:
            self.game_over = True
            if self.players['player1']['score'] > self.players['player2']['score']: self.winner = 'player1'
            elif self.players['player2']['score'] > self.players['player1']['score']: self.winner = 'player2'
    ...
    def get_game_state(self):
        ...
        return {
            'phase': self.phase,
            'boards': self.boards if self.phase == 'placement' or self.is_test_mode else {},
    ...
    def get_placement_info(self):
        ...
        return {
            'step': self.placement_step, 'current_number': self.placement_sequence[self.placement_step],
    ...
    def get_match_info(self):
        ...
        return {
            'round': self.match_round, 'total_rounds': self.total_rounds,
